...
(message "🔄  Loading diagnostics.el...")
...
(let ((elapsed (float-time (time-subtract (current-time) config-load-start-time))))
  (message "✅  diagnostics.el loaded (%.3f seconds)" elapsed))
