;;; core-packages-utils.el --- Package Management Utility Functions -*- lexical-binding: t -*-
;;; Commentary:
;;      Utility functions for package installation, updates, and management.
;;      Provides interactive commands and helpers for package operations.
...
- Persistent storage prevents duplicate checks across Emacs restarts"
 ...
 ;; Make this module available for loading with (require 'core-packages-utils)
 )

(provide 'core-packages-utils)
