...
(defconst doom-1337-modeline-bg "#4a4a4a" "Modeline background - medium gray.")
...
(defconst doom-1337-color-cyan "#00ff9f" "Primary accent - bright cyan-green.")
(defconst doom-1337-color-purple "#d77dd7" "Secondary accent - bright magenta.")
(defconst doom-1337-color-blue "#5fb3f0" "Tertiary accent - brightened blue.")
(defconst doom-1337-color-orange "#ffb347" "Warnings - brightened orange.")
(defconst doom-1337-color-red "#f0a0a0" "Errors - light coral red for contrast.")
(defconst doom-1337-color-yellow "#ffe66d" "Modified/attention - yellow.")
(defconst doom-1337-color-green "#7bc275" "Success - green.")
(defconst doom-1337-color-teal "#7dd0d0" "Info/time - soft cyan-teal.")
(defconst doom-1337-color-light-gray "#d0d0d0" "Light text - brightened gray.")
(defconst doom-1337-color-dim-gray "#a0a0a0" "Dim text - medium gray.")
