...
(safe-load-config 'modeline-segments "Custom modeline segments")
...
(safe-load-config 'c-config "C/C++ language support")
...
(safe-load-config 'python-config "Python configuration")
